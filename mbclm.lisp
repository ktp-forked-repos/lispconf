...
;;#+asdf
;;(progn
;;  (push "/home/oleo/quicklisp/dists/quicklisp/software/cl-unicode-0.1.4/" asdf:*central-registry*)
;;  (push "/home/oleo/quicklisp/dists/quicklisp/software/cl-ppcre-2.0.6/" asdf:*central-registry*)
;;  (push "/home/oleo/quicklisp/dists/quicklisp/software/trivial-gray-streams-20131211-git/" asdf:*central-registry*)
;;  (push "/home/oleo/quicklisp/dists/quicklisp/software/flexi-streams-1.0.12/" asdf:*central-registry*)
;;  (push "/home/oleo/quicklisp/dists/quicklisp/software/usocket-0.6.1/" asdf:*central-registry*)
;;  (push "/home/oleo/quicklisp/dists/quicklisp/software/usocket-udp-2.6/" asdf:*central-registry*)
;;  (push "/home/oleo/quicklisp/dists/quicklisp/software/zpb-ttf-1.0.3/" asdf:*central-registry*)
;;  (push "/home/oleo/quicklisp/dists/quicklisp/software/cl-vectors-20130312-git/" asdf:*central-registry*)
;;  (push "/home/oleo/quicklisp/dists/quicklisp/software/clx-20131003-git/" asdf:*central-registry*)
;;  (push "/home/oleo/quicklisp/dists/quicklisp/software/mcclim-20130813-cvs/" asdf:*central-registry*)
;;  (push "/home/oleo/quicklisp/dists/quicklisp/software/mcclim-20130813-cvs/Experimental/freetype/" asdf:*central-registry*)

;;  (push "/home/oleo/quicklisp/dists/quicklisp/software/mcclim-20130813-cvs/Apps/Functional-Geometry/" asdf:*central-registry*)
;;  (push "/home/oleo/mcclim-0.9.6/" asdf:*central-registry*)
;;  (push "/home/oleo/quicklisp/dists/quicklisp/software/flexichain_1.5.1/" asdf:*central-registry*)
;;  (push "/home/oleo/quicklisp/dists/quicklisp/software/spatial-trees-20131211-git/" asdf:*central-registry*)
;;  (push "/home/oleo/quicklisp/dists/quicklisp/software/climacs-20101006-cvs/" asdf:*central-registry*)
;;  (push "/home/oleo/quicklisp/dists/quicklisp/software/slime-20131211-cvs/" asdf:*central-registry*)
;;  (push "/home/oleo/quicklisp/dists/quicklisp/software/split-sequence-1.1/" asdf:*central-registry*)
;;  (push "/home/oleo/quicklisp/dists/quicklisp/software/cl-irc-0.9.1/" asdf:*central-registry*)
;;  (push "/home/oleo/quicklisp/dists/quicklisp/software/bordeaux-threads-0.8.3/" asdf:*central-registry*)
;;  (push "/home/oleo/quicklisp/dists/quicklisp/software/alexandria-20130128-git/" asdf:*central-registry*)
;;  (push "/home/oleo/quicklisp/dists/quicklisp/software/cl-fad-0.7.2/" asdf:*central-registry*)
;;  (push "/home/oleo/quicklisp/dists/quicklisp/software/beirc-20101107-cvs/" asdf:*central-registry*)
...
#+:quicklisp
(ql:quickload :mcclim-fonts)
(asdf:oos 'asdf:load-op :mcclim-fonts)

#+:quicklisp
(ql:quickload :mcclim-clx/pretty)
...
;;    (setf mcclim-clx::*clx-text-family+face-map*
;;      (clim-user::update-map-for-face-with-name
;;  	mcclim-clx::*clx-text-family+face-map* :fix clim-user::*default-font-family-name*))))

;;(defmethod asdf:perform :around ((o asdf:load-op) (c (eql (asdf:find-system :mcclim-clx))))
;;  (eval `(defmethod initialize-instance :around ((port ,(intern "CLX-PORT" :mcclim-clx)) &rest args)
;;	   (setf (symbol-value (intern "*CLX-TEXT-FAMILY+FACE-MAP*" :mcclim-clx))
;;	     (update-map-for-face-with-name
;;	       (symbol-value (intern "*CLX-TEXT-FAMILY+FACE-MAP*" :mcclim-clx))
...
;;    (ignore-errors
;;      (progn
;;	(load "/home/oleo/prg/lisp/lisp/onlisp.lisp")
;;	(load "/home/oleo/prg/lisp/lisp/onlisp-original.lisp")
;;	(load "/home/oleo/prg/lisp/lisp/acl2.lisp")
;;	(load "/home/oleo/prg/lisp/lisp/acl2-original.lisp")
;;	(load "/home/oleo/prg/lisp/lisp/lol-working.lisp")
;;	(load "/home/oleo/prg/lisp/lisp/lol-book.lisp")
;;	(load "/home/oleo/prg/lisp/lisp/generators.lisp")))))
...
(load "/home/oleo/clocc/clocc.lisp")
(setf *clocc-root* "/home/oleo/clocc/")
...
(export 'cl-user::datetime)
(export 'cl-user::tokenize-sentence)
(export 'cl-user::replace-all)
(export 'cl-user::join-strings)
(export 'cl-user::space-split)
(export 'cl-user::period-split)
(export 'cl-user::comma-split)
(export 'cl-user::colon-split)
(export 'cl-user::lparen-split)
(export 'cl-user::rparen-split)
(export 'cl-user::paren-split)
(export 'cl-user::lbracket-split)
(export 'cl-user::rbracket-split)
(export 'cl-user::bracket-split)
(export 'cl-user::lbrace-split)
(export 'cl-user::rbrace-split)
(export 'cl-user::brace-split)
(export 'cl-user::space-join)
(export 'cl-user::period-join)
(export 'cl-user::comma-join)
(export 'cl-user::colon-join)
(export 'cl-user::lparen-join)
(export 'cl-user::rparen-join)
(export 'cl-user::paren-join)
(export 'cl-user::lbracket-join)
(export 'cl-user::rbracket-join)
(export 'cl-user::bracket-join)
(export 'cl-user::lbrace-join)
(export 'cl-user::rbrace-join)
(export 'cl-user::brace-join)


(in-package :clim-user)
(import 'cl-user::datetime)
(import 'cl-user::tokenize-sentence)
(import 'cl-user::replace-all)
(import 'cl-user::join-strings)
(import 'cl-user::space-split)
(import 'cl-user::period-split)
(import 'cl-user::comma-split)
(import 'cl-user::colon-split)
(import 'cl-user::lparen-split)
(import 'cl-user::rparen-split)
(import 'cl-user::paren-split)
(import 'cl-user::lbracket-split)
(import 'cl-user::rbracket-split)
(import 'cl-user::bracket-split)
(import 'cl-user::lbrace-split)
(import 'cl-user::rbrace-split)
(import 'cl-user::brace-split)
(import 'cl-user::space-join)
(import 'cl-user::period-join)
(import 'cl-user::comma-join)
(import 'cl-user::colon-join)
(import 'cl-user::lparen-join)
(import 'cl-user::rparen-join)
(import 'cl-user::paren-join)
(import 'cl-user::lbracket-join)
(import 'cl-user::rbracket-join)
(import 'cl-user::bracket-join)
(import 'cl-user::lbrace-join)
(import 'cl-user::rbrace-join)
(import 'cl-user::brace-join)
